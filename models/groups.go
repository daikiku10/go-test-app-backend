...
var (
	groupAllColumns            = []string{"id", "name", "created_at", "update_at"}
	groupColumnsWithoutDefault = []string{"name", "created_at", "update_at"}
...
func FindGroup(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Group, error) {
	groupObj := &Group{}
...
func GroupExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
