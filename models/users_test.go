...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `FamilyName`: `varchar`, `FamilyNameKana`: `varchar`, `FirstName`: `varchar`, `FirstNameKana`: `varchar`, `Email`: `varchar`, `Password`: `varchar`, `CreatedAt`: `datetime`, `UpdateAt`: `datetime`}
	_           = bytes.MinRead
)
