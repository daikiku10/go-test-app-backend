...
type User struct { // ユーザーの識別子
	ID uint64 `boil:"id" json:"id" toml:"id" yaml:"id"`
	// 苗字
	FamilyName string `boil:"family_name" json:"family_name" toml:"family_name" yaml:"family_name"`
	// 苗字カナ
	FamilyNameKana string `boil:"family_name_kana" json:"family_name_kana" toml:"family_name_kana" yaml:"family_name_kana"`
	// 名前
...
var UserTableColumns = struct {
	...
	FamilyNameKana: "users.family_name_kana",
	FirstName:      "users.first_name",
	FirstNameKana:  "users.first_name_kana",
	Email:          "users.email",
...
var UserWhere = struct {
	...
	FamilyNameKana whereHelperstring
	...
	FamilyNameKana: whereHelperstring{field: "`users`.`family_name_kana`"},
...
var (
	userAllColumns            = []string{"id", "family_name", "family_name_kana", "first_name", "first_name_kana", "email", "password", "created_at", "update_at"}
	userColumnsWithoutDefault = []string{"family_name", "family_name_kana", "first_name", "first_name_kana", "email", "password", "created_at", "update_at"}
